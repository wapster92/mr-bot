...
- Реализовать интеграцию с GitLab/GitHub для получения статусов пайплайнов и MR.
- Добавить хранение состояния (например, Redis/PostgreSQL) и план команд.
- Подключить аутентификацию по списку разрешённых пользователей/чатов.
